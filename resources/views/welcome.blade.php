    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lgc-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">Portfolio</a></li>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Willkommen bei WortWölkchen!</h1>
                <!-- Icon Divider-->
                    ...
                    <div class="col-lg-8 col-xl-7">
                        <form id="contactForm" method="post" action="{{url('survey-create')}}"">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <div class="invalid-feedback" data-sb-feedback="question:required">Ohne Fage gehts leider nicht.</div>
                            </div>
                            <!-- Email address input-->
                            <div class="form-floating mb-3">
