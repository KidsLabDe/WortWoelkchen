...
<body>
    <nav class="navbar navbar-expand-md fixed-top navbar-shrink py-3 navbar-light" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center"
                href="/"><span>WortWölkchen.de</span></a><button class="navbar-toggler"
                data-bs-toggle="collapse"><span class="visually-hidden">Toggle navigation</span><span
        ...
        <div class="container py-4 py-lg-5">
            <div class="row row-cols-2 row-cols-md-4">
                <div class="col-12 col-md-12">
                    <div class="fw-bold d-flex align-items-center mb-2"><span>WortWölkchen ist ein Angebon von
                            KidsLab.de</span></div>
            ...
            <div class="text-muted d-flex justify-content-between align-items-center pt-3">
                ...
                <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                            fill="currentColor" viewBox="0 0 16 16" class="bi bi-lightbulb">
                            <path
